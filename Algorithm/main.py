...
def path_finding_v2():
    ...
    cfg = PlannerV2Config(
        ...
        allow_reverse_turn=bool(content.get('allow_reverse_turn', True)),
        ...
        w_leg_distance_quad=float(content.get('w_leg_distance_quad', 0.08)),
        w_leg_turn_quad=float(content.get('w_leg_turn_quad', 0.03)),
